...
import HomePageImage from '../Assets/Images/aboutMainImage.png';

function HomePage(){
    return (

        <HomeLayout>
            <div className="pt-10 text-white flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-10 mx-4 sm:mx-16 h-[90vh]">
